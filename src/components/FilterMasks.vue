        ...
        <div class="md-layout md-gutter">
            <div class="md-layout-item">
                <md-field id="filter-field">
                    ...
                    <md-select v-model="filter.filterBy" name="filter" id="filter" placeholder="Filter by" @md-selected="filterMasks">
                        <md-option value="" v-if="filter.filterBy"></md-option>
                        <md-option v-for="filterVal in filters" :key="filterVal" :value="filterVal.toLowerCase()">{{filterVal}}</md-option>
                    </md-select>
                </md-field>
            </div>            
            <div class="md-layout-item">
                <md-field id="filter-field">
                    ...
                    <md-select v-model="filter.tags" name="tags" id="tags" placeholder="Tags" @md-selected="filterMasks" multiple>
